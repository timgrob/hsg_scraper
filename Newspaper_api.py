...
while flag:
  url = 'https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=syria&facet_field=day_of_week&facet=true&begin_date=20110329&end_date=20110429&api-key=yLQx1LlB0u5YAqjus1vYhBDa6ILAXObk&page={}'.format(p)
